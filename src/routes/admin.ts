 ...
 */
async function handleGetEmailConfig(request: Request, env: Env): Promise<Response> {
	try {
		return new Response(JSON.stringify({
			success: true,
 ...
 */
async function handleTestEmail(request: Request, env: Env, path: string): Promise<Response> {
	try {
