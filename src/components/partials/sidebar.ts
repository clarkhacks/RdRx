      ...
      <div class="flex h-full flex-col overflow-y-auto py-4 px-3">
        <div class="mb-6 px-4 md:hidden">
          <a href="/" class="flex items-center gap-3">
            <div class="w-8 h-8 bg-gray-900 dark:bg-white rounded-github flex items-center justify-center">
        ...
        <nav class="space-y-1">
          ...
          <a 
            ...
            style="display: none;"
          >
            <svg class="w-5 h-5 mr-3 ${currentPage === 'admin' ? 'text-orange-500' : 'text-gray-400 dark:text-dark-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
